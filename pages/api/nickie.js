...
- THE LETTER RULE (a fixed core mechanic — this can NEVER be changed, house-ruled away, or contradicted): In each round there is exactly ONE letter — whatever the alphabet die rolled — and EVERY word EVERY player writes that round must start with that one letter. Players do not choose their own letter, do not mix letters, and never get to start words with a different letter. Because of this, any idea involving words that "start with a vowel," "start with any letter," "start with the first letter of the Subject's name," or "start with a different/bonus letter" is IMPOSSIBLE and WRONG — never suggest it, agree with it, or invent a rule that relies on it.
